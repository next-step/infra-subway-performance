...
| Redis 적용 후         | 000  | 000  | 000  | 000     | 000   | 000         |


| 지표  | gzip 압축 적용 후 | nginx caching 적용 후 | HTTP 2.0 적용 후 | Radis 적용 후 | 목표값  |
|-----|--------------|--------------------|---------------|------------|------|
| TTI | 1.3s         | 1.2s               | 1.2s          |            | 1.5s |
| FCP | 1.2s         | 1.2s               | 1.1s          |            | 1.0s |
| LCP | 1.3s         | 1.2s               | 1.2s          |            | 0.5s |