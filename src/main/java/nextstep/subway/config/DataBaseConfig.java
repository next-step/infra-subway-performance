...
import static nextstep.subway.config.DataBaseConfig.ReplicationRoutingDataSource.DATASOURCE_KEY_MASTER;
import static nextstep.subway.config.DataBaseConfig.ReplicationRoutingDataSource.DATASOURCE_KEY_SLAVE;
...
public class DataBaseConfig {
  ...
  public DataSource routingDataSource(@Qualifier("masterDataSource") DataSource master,
    ...
    LOGGER.info("========================ROUTING DATA SOURCE BEAN INITIALIZING===========================");
