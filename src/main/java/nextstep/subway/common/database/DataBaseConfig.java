...
import static nextstep.subway.common.database.ReplicationRoutingDataSource.*;
...
public class DataBaseConfig {
    ...
    public DataSource routingDataSource(
        @Qualifier("masterDataSource") DataSource master, @Qualifier("slaveDataSource") DataSource slave
    ) {
