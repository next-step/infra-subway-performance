...
import static nextstep.subway.configuration.ReplicationRoutingDataSource.DATASOURCE_KEY_MASTER;
import static nextstep.subway.configuration.ReplicationRoutingDataSource.DATASOURCE_KEY_SLAVE;
...
public class DatabaseConfig {
    ...
    public DataSource routingDataSource(
        ...
        replicationRoutingDataSource.setTargetDataSources(sources);
