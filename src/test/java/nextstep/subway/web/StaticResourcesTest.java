...
import nextstep.subway.common.support.SubwayVersion;
...
public class StaticResourcesTest {
    ...
    @DisplayName("css resource 캐시 테스트 : max-age 1년")
    @Test
    ...
    @DisplayName("js resource 캐시 테스트 : no-cache, private")
    @Test
    ...
    @DisplayName("그외 resource 캐시 테스트 : no-cache, private")
    @Test
    void get_static_resources_others() {
