...
import nextstep.subway.websupport.StaticResourceVersion;
...
import static nextstep.subway.websupport.HttpCacheConfig.PREFIX_STATIC_RESOURCES;
...
public class StaticResourceTest {
    ...
    void get_static_resources_css() {
        String uri = PREFIX_STATIC_RESOURCES + "/" + version.getVersion() + "/css/basic.css";
        EntityExchangeResult<String> response = client
                .get()
                .uri(uri)
                .exchange()
