...
function git_clone() {
  git clone -b ${BRANCH} --single-branch https://github.com/tasklet1579/infra-subway-performance.git
}
...
function gradle_build() {
  cd /home/ubuntu/infra-subway-performance
  ./gradlew clean build
}
